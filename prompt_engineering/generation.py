...
plant_parameters = {
    "general": {
        ...
        "outputs" : ["Day Temperature (°C)", "Night Temperature (°C)", "Optimal Humidity (%)","Nitrogen (mg/L)", "Phosphorus (mg/L)", "Potassium (mg/L)", "Calcium (mg/L)", "Magnesium (mg/L)","Sulfur (mg/L)", "Common Pests", "Common Diseases","Plant Spacing (cm)","Plant Density (Plants/m²)", "Expected Yield Quantity (kg/m²)", "Harvesting Time","Weekly Growth (cm/week)","Plant Height (cm)","Leaf Color (RGB)"],
    },
    "Environment": {
        "Outdoor": {
            "inputs": ["climate"],
        ...
        "Shadehouse": {
            ...
            "outputs": ["Shade Percentage (%)", "Light Type", "Light Spectrum", "Light Duration (hours/Day)", "Light Intensity"]
        },
        "Greenhouse": {
            "inputs": ["heating_system", "cooling_system", "ventilation_system","humidification_system", "dehumidification_system"],
            "outputs": ["Heating Setpoint (°C)", "Cooling Setpoint (°C)", "Ventilation Rate", "Humidification Setpoint (%)", "Dehumidification Setpoint (%)", "Light Type", "Light Spectrum", "Light Duration (hours/Day)", "Light Intensity"]
        },
    },
    "Farming type": {
        "Soil-Based": {
            "inputs": ["soil_type", "irrigation_method"],
            "outputs": [ "Soil pH", "Soil Moisture (%)", "Watering duration (Minutes)", "Watering Frequency (Times per Day)", "Recommended Fertilizer", "Fertilizer Application Rate (g/m²)", "Fertilizer Application Frequency (Times per week)"]
        },
        "Soilless": {
            "inputs" : ["growing_medium" , "irrigation_method"],
            "outputs" : ["Growing medium pH", "Growing Medium Water content (%)", "Watering duration (Minutes)", "Watering Frequency (Times per Day)", "Recommended Fertilizer", "Fertilizer Application Rate (g/m²)", "Fertilizer Application Frequency (Times per week)"]
        },
        "Hydroponic": {
            "inputs" : ["Hydroponic_system_type" , "Growing_medium"],
            "outputs" : ["Water pH", "EC Value (dS/m)", "Dissolved Oxygen (mg/L)", "Iron (mg/L)", "Manganese (mg/L)", "Zinc (mg/L)", "Copper (mg/L)", "Boron (mg/L)", "Molybdenum (mg/L)", "Chlorine (mg/L)"]
        },
        "Aeroponic": {
            "inputs" : ["Aeroponic_system_type" , "Growing_medium"],
            "outputs" : ["Water pH", "EC Value (dS/m)", "Mist Frequency (min)", "Mist Duration (sec)", "Iron (mg/L)", "Manganese (mg/L)", "Zinc (mg/L)", "Copper (mg/L)", "Boron (mg/L)", "Molybdenum (mg/L)", "Chlorine (mg/L)"]
        },
        "Aquaponic": {
            "inputs" : ["Aquaponic_system_type" , "Fish_Type"],
            "outputs" : ["Water pH", "EC Value (dS/m)", "Dissolved Oxygen (mg/L)","Fish Feed Type", "Fish Feed Quentity (g/Day)","Water Temperature (°C)","Ammonia Level (ppm)", "Nitrite Level (ppm)", "Nitrate Level (mg/L)", "Iron (mg/L)", "Manganese (mg/L)", "Zinc (mg/L)", "Copper (mg/L)", "Boron (mg/L)", "Molybdenum (mg/L)", "Chlorine (mg/L)"]
        },
        "Vertical Farming": {
            "inputs" : ["Vertical_Farming_system_type" , "Growing_medium"],
            "outputs" : ["Water pH", "EC Value (dS/m)","Watering duration (Minutes)", "Watering Frequency (Times per Day)","Iron (mg/L)", "Manganese (mg/L)", "Zinc (mg/L)", "Copper (mg/L)", "Boron (mg/L)", "Molybdenum (mg/L)", "Chlorine (mg/L)"]
        }, 
    }
    
}

def generate_prompt(plant_parameters, plant_type, plant_variety, plant_health, growth_stage, environment, farming_type, additional_inputs):
